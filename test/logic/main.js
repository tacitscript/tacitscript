...
describe("Code Abbey", () => {
	...
	*/
		it("result = [1342280,760517,855850,1041029,996670,1362147,533229,1055895,1108761,164293,1159457,1212979,1249813,1898796,1084651]", () => expect(result).eql([1342280,760517,855850,1041029,996670,1362147,533229,1055895,1108761,164293,1159457,1212979,1249813,1898796,1084651]));
	});

	describe("#2 Sum in Loop", () => {
	/*ts
	...
	*/
		it("result = 29822", () => expect(result).eql(29822));
	});
});
