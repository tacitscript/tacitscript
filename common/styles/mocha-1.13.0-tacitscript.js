;(function(){
    ...
    Mocha.prototype.run = function(fn, id){
      if (this.files.length) this.loadFiles();
      var suite = this.suite;
      var options = this.options;
      var runner = new exports.Runner(suite);
      var reporter = new this._reporter(runner, undefined, id);
    ...
    function HTML(runner, root, id) {
      ...
      root = root || document.getElementById(id || 'mocha');
