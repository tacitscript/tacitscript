	...
	return <div id="type-signatures" className={`panel${isOpen ? " open" : ""}`} {...style}>
		...
		{isOpen ? <div className="contents">
			...
			<div>
				...
				<p>When using a type signature to denote the type of a symbol (a form of <a href="https://en.wikipedia.org/wiki/Hungarian_notation">Hungarian notation</a>), operators are reduced to <b>I</b> for infix operators and <b>P</b> for prefix operators.</p>
				<div className="code-block table-data">{getOperationExamples([
				...
				<div className="code-block table-data">{getOperationExamples([
					["R", <span>A <b>R</b>eal (eg. decimal precision) number, eg. 10, 3.14</span>],
