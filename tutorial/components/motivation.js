	...
	return <div id="motivation" className={`panel${isOpen ? " open" : ""}`} {...style}>
		...
		{isOpen ? <div className="contents">
			...
			<div>
				...
				<p>While superficially appearing similar to J, semantically, the language shares much more DNA with functional languages.
					It borrows from the ML family (automatic currying, purity) and LISP family (homoiconicity). As a functional language, is unusual in missing the core <i>lambda</i> construct.
				</p>
