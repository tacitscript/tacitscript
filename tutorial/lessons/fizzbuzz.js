...
export default {
	id: "fizzbuzz",
	name: "Fizzbuzz",
	operations: <React.Fragment><a href="#generate">(^) generate</a>, <a href="#and">(&) and</a>, <a href="#remainder">(%) remainder</a>, <a href="#identity">(;) identity</a>, <a href="#tap">(&gt;) tap</a></React.Fragment>,
	exercise: {
		question: <div>
