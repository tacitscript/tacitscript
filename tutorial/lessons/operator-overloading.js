...
export default {
	...
	description: <div>
		<p>The particular operation that an operator resolves to, in an expression, depends on the types of the surrounding symbols.</p>
		<p>Between strings or arrays, the <a href="#plus">plus (+)</a> operator will resolve to a <a href="#concat">(+) concat</a> operation.</p>
		...
		supports <span className="code">2+</span> to the left of <a href="#underscore">underscore (_)</a>. Parentheses are required in this case.</p>
