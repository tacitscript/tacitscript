...
export default {
	...
	description: <div>
		<p>In tacitscript, each standard <i>operator</i>, eg. <a href="#plus">+</a>, may represent one of many possible <i>operations</i>, eg. <a href="#add">+ (add)</a> or <a href="#concat">+ (concat)</a>.</p>
	...
	exercise: {
		...
		tests: [
			...
			{description: "uses all four arithmetic operations", condition: ({es6}) => ["ts.plus", "ts.minus", "ts.asterisk", "ts.slash"].every(symbol => es6.includes(symbol))},
