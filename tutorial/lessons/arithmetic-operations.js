...
export default {
	...
	description: <div>
		<p>In tacitscript, each standard <i>symbol</i>, eg. <a href="#plus">+</a>, may represent one of many possible <i>operators</i>, eg. <a href="#add">(+) add</a> or <a href="#concat">(+) concat</a>.</p>
		<p>tacitscript uses the standard arithmetic operators <a href="#add">(+) add</a>, <a href="#subtract">(-) subtract</a>, <a href="#multiply">(*) multiply</a> and <a href="#divide">(/) divide</a>.</p>
		<p>Operators have equal precedence, and are <i>left-associative</i>.</p>
